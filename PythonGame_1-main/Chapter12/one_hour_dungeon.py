...
# 이미지 로딩
imgTitle = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\title.png")
imgWall = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\wall.png")
imgWall2 = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\wall2.png")
imgDark = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\dark.png")
imgPara = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\parameter.png")
imgBtlBG = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\btlbg.png")
imgEnemy = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\enemy0.png")
imgItem = [
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\potion.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\blaze_gem.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\spoiled.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\apple.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\meat.png")
]
imgFloor = [
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\floor.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\tbox.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\cocoon.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\stairs.png")
]
imgPlayer = [
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\mychr0.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\mychr1.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\mychr2.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\mychr3.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\mychr4.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\mychr5.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\mychr6.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\mychr7.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\mychr8.png")
]
imgEffect = [
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\effect_a.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\effect_b.png")
]
...
def init_battle():  # 전투 시작 준비
    ...
    imgEnemy = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\image\enemy" + str(typ) + ".png")
...
def main():  # 메인 처리
    ...
    se = [  # 효과음 및 징글
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\sound\ohd_se_attack.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\sound\ohd_se_blaze.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\sound\ohd_se_potion.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\sound\ohd_jin_gameover.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\sound\ohd_jin_levup.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\sound\ohd_jin_win.ogg")
    ]
    ...
    while True:
        ...
        if idx == 0:  # 타이틀 화면
            if tmr == 1:
                pygame.mixer.music.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\sound\ohd_bgm_title.ogg")
            ...
            if key[K_SPACE] == 1:
                ...
                blazegem = 0
                idx = 1
                pygame.mixer.music.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\sound\ohd_bgm_field.ogg")
                pygame.mixer.music.play(-1)
            ...
            if tmr == 1:
                pygame.mixer.music.load(r"C:\Users\Blackstorm_plecios\Desktop\PythonGame_1-main\Chapter12\sound\ohd_bgm_battle.ogg")
                pygame.mixer.music.play(-1)
                init_battle()
                init_message()
            elif tmr <= 4:
