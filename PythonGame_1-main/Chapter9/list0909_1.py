...
def game_main():
    ...
    if index == 0:  # 타이틀 로고
        ...
        if timer == 50:
            ...
            index = 0
    cvs.delete("INOF")
    draw_txt("SCORE " + str(score), 160, 60, 32, "blue", "INOF")
    if tsugi > 0:
        cvs.create_image(752, 128, image=img_neko[tsugi], tag="INOF")
...
bg = tkinter.PhotoImage(file="C:\\Users\\Blackstorm_plecios\\Desktop\\PythonGame_1-main\\Chapter9\\neko_bg.png")
cursor = tkinter.PhotoImage(file="C:\\Users\\Blackstorm_plecios\\Desktop\\PythonGame_1-main\\Chapter9\\neko_cursor.png")
img_neko = [
    None,
    tkinter.PhotoImage(file="C:\\Users\\Blackstorm_plecios\\Desktop\\PythonGame_1-main\\Chapter9\\neko1.png"),
    tkinter.PhotoImage(file="C:\\Users\\Blackstorm_plecios\\Desktop\\PythonGame_1-main\\Chapter9\\neko2.png"),
    tkinter.PhotoImage(file="C:\\Users\\Blackstorm_plecios\\Desktop\\PythonGame_1-main\\Chapter9\\neko3.png"),
    tkinter.PhotoImage(file="C:\\Users\\Blackstorm_plecios\\Desktop\\PythonGame_1-main\\Chapter9\\neko4.png"),
    tkinter.PhotoImage(file="C:\\Users\\Blackstorm_plecios\\Desktop\\PythonGame_1-main\\Chapter9\\neko5.png"),
