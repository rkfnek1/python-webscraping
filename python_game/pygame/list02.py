...
root =tkinter.Tk()
root.title("객체 지향 프로그래밍")
canvas = tkinter.Canvas(root, width=800, height=560, bg="white")
canvas.pack()

character = [
    GameCharacter("검사", 200, r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygame\swordsman.png"),
    GameCharacter("닌자", 160, r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygame\ninja.png")
]
