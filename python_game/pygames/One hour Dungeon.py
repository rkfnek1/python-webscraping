...
# 이미지 로딩
imgTitle = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\title.png")
imgWall = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\wall.png")
imgWall2 = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\wall2.png")
imgDark = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\dark.png")
imgPara = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\parameter.png")
imgBtlBG = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\btlbg.png")
imgEnemy = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\enemy0.png")
imgItem = [
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\potion.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\blaze_gem.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\spoiled.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\apple.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\meat.png")
]
imgFloor = [
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\floor.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\tbox.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\cocoon.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\stairs.png")
]
imgPlayer = [
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\mychr0.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\mychr1.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\mychr2.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\mychr3.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\mychr4.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\mychr5.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\mychr6.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\mychr7.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\mychr8.png")
]
imgEffect = [
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\effect_a.png"),
    pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\effect_b.png")
]

# 변수 선언
speed = 1 # 게임의 전체 속도 관리
idx = 0 # 게임 진행 관리
tmr = 0 # 게임 진행 관리
floor = 0 # 현재 층 수
fl_max = 1 # 도달한 층 수 (최대값)
welcome = 0 # "Welcome to floor*" 메시지 표시 시간

pl_x = 0 # 주인공의 던전 내 위치, 방향, 애니메이션 패턴
pl_y = 0 # 주인공의 던전 내 위치, 방향, 애니메이션 패턴
pl_d = 0 # 주인공의 던전 내 위치, 방향, 애니메이션 패턴
pl_a = 0 # 주인공의 던전 내 위치, 방향, 애니메이션 패턴
pl_lifemax = 0 # 주인공의 생명 최대값 
pl_life = 0 # 주인공의 생명
pl_str = 0 # 주인공의 공격력
food = 0 # 식량
potion = 0 # 입수한 Potion 수
blazegem = 0 # 입수한 Blaze gem 수
treasure = 0 # 보물 상자를 열거나, 누에고치에 닿았을 대 출현하는 것

emy_name = "" # 적 이름
emy_lifemax = 0 # 적 생명 최대값
emy_life = 0 # 적 생명
emy_str = 0 # 적 공격력
emy_x = 0 # 적 이미지 전추 화면 내 표시 x좌표
emy_y = 0 # 적 이미지 전추 화면 내 표시 y좌표
emy_step = 0 # 적 표시 연출 수행 관리 변수, 이미지 앞뒤 움직임 관리
emy_blink = 0 # 적 표시 연출 수행 관리 변수, 이미지 깜빡임 관리

dmg_eff = 0 # 플레이어가 충격을 받았을 때 화면을 흔들기 위한 변수
btl_cmd = 0 # 전투에서 사용하는 커맨트 값 대입
...
def init_battle(): # 전투 시작 준비
    ...
    imgEnemy = pygame.image.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\image\enemy" + str(typ) + ".png")
...
def main(): # 메인 처리
    ...
    dmg = 0 # 공격 시 데미지 값 계산
    lif_p = 0 # 주인공 성장 시 생명 최대값 증가량
    str_p = 0 # 주인공 성장 시 공격력 증가량
    ...
    se = [ # 효과음 및 징글
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\sound\ohd_se_attack.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\sound\ohd_se_blaze.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\sound\ohd_se_potion.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\sound\ohd_jin_gameover.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\sound\ohd_jin_levup.ogg"),
        pygame.mixer.Sound(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\sound\ohd_jin_win.ogg")
    ]
    ...
    while True:
        ...
        if idx == 0: # 타이틀 화면
            if tmr == 1:
                pygame.mixer.music.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\sound\ohd_bgm_title.ogg")
            ...
            if key[K_SPACE] == 1:
                ...
                blazegem = 0
                idx = 1
                pygame.mixer.music.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\sound\ohd_bgm_field.ogg")
                pygame.mixer.music.play(-1)
            ...
            if tmr == 1:
                pygame.mixer.music.load(r"C:\Users\Blackstorm_plecios\Desktop\python_game\pygames\sound\ohd_bgm_battle.ogg")
                pygame.mixer.music.play(-1)
                init_battle()
                init_message()
            elif tmr <= 4:
