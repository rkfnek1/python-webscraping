...
def thisisgame_slack_Share():
    ...
    for i in range(1):
        ...
        news_list = soup.find("div", attrs={"class":("news-list")}).find_all("li", limit=9) # 설정한 갯수만큼만 기사를 써치
...
def inven_slack_Share():
    ...
    for i in range(1):
        ...
        news_list = soup.find("div", attrs={"class":"list"}).find_all("td", limit=9)
        # print(news_list)
...
#         # news_list = soup.find("div", attrs={"class":"view-cont"}).find_all("li", limit=7)
#         print(news_list)
